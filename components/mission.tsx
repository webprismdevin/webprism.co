...
const Mission = (props: MissionProps) => {
    return(<>
      <Content fullheight title="We see you.">
        ...
        <p className="block is-size-5">Whether it be a hobby turned side-hustle, a thriving business ready to grow, or a burning desire to share your talents far and wide, we can help you realize your vision and take it to the next level.</p>
