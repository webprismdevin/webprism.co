export function returnStatement(step: number) {
  switch (step) {
    ...
    case 4:
      return "We take the written content, identify tone being conveyed, and establish to overall vibe. From there, we craft a website design that will visually communicate the your brand’s unique personality and character to your audience. This part of the process is iterative, explorational, and tons of fun.";
    case 5:
